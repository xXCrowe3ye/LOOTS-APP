...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addToCartButton = (Button) findViewById(R.id.prodAddToCart);
        numberButton = (ElegantNumberButton) findViewById(R.id.numCounterBtn);
        productImage = (ImageView) findViewById(R.id.prodImageDetails);
        productName = (TextView) findViewById(R.id.prodNameDetails);
        productDescription = (TextView) findViewById(R.id.prodDescriptionDetails);
