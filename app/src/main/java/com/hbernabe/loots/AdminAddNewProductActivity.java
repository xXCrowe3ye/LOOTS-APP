...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AddNewProductButton = (Button) findViewById(R.id.addNewProd);
        InputProductImage = (ImageView) findViewById(R.id.chooseProductImage);
        InputProductName = (EditText) findViewById(R.id.prodName);
        InputProductDescription = (EditText) findViewById(R.id.prodDescription);
        InputProductPrice = (EditText) findViewById(R.id.prodPrice);
